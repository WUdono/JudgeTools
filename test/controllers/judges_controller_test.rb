...
class JudgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create judge" do
    assert_difference('Judge.count') do
      post judges_url, params: { judge: { admin_user: @judge.admin_user, name: @judge.name, passsword: @judge.passsword } }
    end
  ...
  test "should update judge" do
    patch judge_url(@judge), params: { judge: { admin_user: @judge.admin_user, name: @judge.name, passsword: @judge.passsword } }
