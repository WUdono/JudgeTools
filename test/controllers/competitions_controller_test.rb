...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { date: @competition.date, stage_id: @competition.stage_id, table_estimation_id: @competition.table_estimation_id, term_id: @competition.term_id } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { date: @competition.date, stage_id: @competition.stage_id, table_estimation_id: @competition.table_estimation_id, term_id: @competition.term_id } }
